              ...
              <div class="bot">
                <table>
                  ...
                  <tr>
                    ...
                    <td class="bold"></td>
                    <td class="bold">${ele.hgLPayAmount&&ele.hgLPayAmount!=0? ele.hgLPayAmount : ''}</td>
                  ...
                  <td class="bold">中  奖</td>
                    ...
                    <td class="gray"></td>
                    <td class="gray">${ele.hgLBenefitAmount&&ele.hgLBenefitAmount > 0? ele.hgLBenefitAmount : ''}</td>
                    <td class="gray"></td>
                  </tr>
                </table>
              </div>
            ...
            <div class="bot bot-history">
                <table>
                  ...
                  <tr>
                    ...
                    <td class="bold"></td>
                    <td class="bold">${ele.hisTopTtg.hgLPayAmount&&ele.hisTopTtg.hgLPayAmount!=0? ele.hisTopTtg.hgLPayAmount : ''}</td>
                  ...
                  <td class="bold">中  奖</td>
                    ...
                    <td class="gray"></td>
                    <td class="gray">${ele.hisTopTtg.hgLBenefitAmount&&ele.hisTopTtg.hgLBenefitAmount > 0? ele.hisTopTtg.hgLBenefitAmount : ''}</td>
                    <td class="gray"></td>
                  </tr>
                </table>
              </div>
              ...
              <div class="bot">
                <table>
                  ...
                  <tr>
                    ...
                    <td class="bold"></td>
                    <td class="bold">
                      <input type="number" data-output-key="hgLPayAmount" disabled value=${ele.hgLPayAmount&&ele.hgLPayAmount!=0? ele.hgLPayAmount : ''}>
                    </td>
                    <td class="bold">
                  ...
                  <tr>
                    ...
                    <td class="gray"></td>
                    <td class="gray">
                      <input type="text" data-output-key="hgLBenefitAmount" disabled value=${ele.hgLBenefitAmount&&ele.hgLBenefitAmount > 0 ? ele.hgLBenefitAmount : ''}>
                    </td>
                    <td class="gray"></td>
                  </tr>
                </table>
